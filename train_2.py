...
class TripletModel(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        if overall_f1_score > self.best_f1_score:
            ...
            torch.save(self.best_model_state_dict, 'classbalance_best_model_2.pth')
...
if __name__ == "__main__":
    ...
    loaded_val_dataset = ImageFolder(root='/root/sharespace/wy/AbNormal_Classification/AbNormal_Classification_dataset/split_new_new/val',
